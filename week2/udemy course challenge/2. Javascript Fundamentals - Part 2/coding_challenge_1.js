...
const avgDolphinsScore = calcAverage(dolphinsScore[0], dolphinsScore[1], dolphinsScore[2]);
const avgKoalasScore = calcAverage(koalasScore[0], koalasScore[1], koalasScore[2]);
