...
const sumDolphinsScore = 0;
const sumKoalasScore = 0;
const averageDolphinsScore = 0;
const averageKoalasScore = 0;
dolphinsScore.forEach(function (score) {
  sumDolphinsScore += score;
});
averageDolphinsScore = sumDolphinsScore / dolphinsScore.length;
koalasScore.forEach(function (score) {
  sumKoalasScore += score;
});
averageKoalasScore = sumKoalasScore / koalasScore.length;
